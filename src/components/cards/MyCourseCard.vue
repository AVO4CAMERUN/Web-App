    ...
    <article class="h-[300px] w-[400px] overflow-hidden rounded-lg shadow-lg">
      ...
      <footer class="flex items-center justify-between leading-none p-4">
        ...
        <div class="cursor-pointer">
          <svg class="hover:scale-90 rounded-full" @click="addCourses" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" style="fill: rgba(253, 5, 5, 1);transform: ;msFilter:;">
